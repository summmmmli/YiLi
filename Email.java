...
public class Email {
	...
	public Email(String fname, String lname) {
		this.fname = fname;
		this.lname = lname;
		System.out.println("New Worker: " + this.fname + " " + this.lname);
		
		// Call a method asking for the department - return the department
		this.dept = this.setDept();
		
		// Call a method that returns a random password
		this.password = this.generate_password(defaultPasswordLength);
	...
	private String generate_email() {
		...
		+ "@" + this.dept.toLowerCase() + "." + companySuffix;
	}
	...
	private String generate_password(int length) {
		...
		String symbols = "!@#$%";
		String values = Capital_chars + numbers + symbols;
	...
	public boolean showInfo() {
		System.out.println("\nDISPLAY NAME: " + this.fname + " " + this.lname);
